...
export const DISPLAYABLE_MODULES: Array<{ module: PermissionModule; label: string; description: string }> = [
    ...
    { module: PermissionModule.BILLING,         label: 'Facturacion electronica',  description: 'Emision y consulta de facturas electronicas' },
...
export const clinicRouteModules: Array<{ prefix: string; module: PermissionModule }> = [
    ...
    { prefix: '/clinic/billing',         module: PermissionModule.BILLING },
