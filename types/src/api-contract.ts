...
// Espejo de `nuvet-api/types/src/api-contract.ts` — mantener sincronizado.
// Si añades o cambias tipos aquí, replica el cambio en api/types/src/api-contract.ts.
...
// ─── Fase 3 · Campañas de vacunación (Slice 1) — Espejo ───────────────────
